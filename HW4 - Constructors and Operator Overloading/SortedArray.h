...
SortedArray operator+ (const SortedArray & lhs, const SortedArray & rhs);
SortedArray operator+ (const int & lhs, const SortedArray & rhs);
SortedArray operator+ (const SortedArray & lhs, const int & rhs);
